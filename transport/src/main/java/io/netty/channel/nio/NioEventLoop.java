    ...
    private void processSelectedKey(SelectionKey k, AbstractNioChannel ch) {
        ...
        try {
            ...
            if ((readyOps & (SelectionKey.OP_READ | SelectionKey.OP_ACCEPT)) != 0 || readyOps == 0) {
                // 如果是SocketChannel就会进入AbstractNioByteChannel 对应处理事件就是SelectionKey.OP_READ,
                // 如果是ServerSocketChannel就会进入AbstractMessageByteChannel 对应处理事件就是SelectionKey.OP_ACCEPT
                unsafe.read();
            }
